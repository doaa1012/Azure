...
from django.utils import timezone
from django.db.models import Max
from .models import Objectinfo, Typeinfo, Objectlinkobject, Aspnetusers
from jwt.exceptions import ExpiredSignatureError, InvalidTokenError
import logging
...
def load_lsvs_view(request):
    ...
    try:
        ...
        lsvs_path = os.path.abspath(os.path.join(BASE_FILE_PATH, relative_path.strip('/')))
        ...
        json_file_path = os.path.abspath(os.path.join(BASE_FILE_PATH, json_file_name))
